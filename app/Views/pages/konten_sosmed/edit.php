...
<title>Edit Konten Sosmed</title>
...
<body>
    <div class="container-fluid">
        <div class="form-container shadow rounded">
            ...
            <form action="<?= route_to('konten.update', $konten['id_konten']) ?>" method="POST" enctype="multipart/form-data" id="kontenForm">
                <?= csrf_field() ?>
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul Konten" value="<?= old('judul', $konten['judul']) ?>" required>
                            <label for="judul">
                        ...
                        <div class="form-floating">
                            <select class="form-select" id="id_bisnis" name="id_bisnis" required onchange="loadSosmedCheckboxes(this.value)">
                                ...
                                <?php foreach ($allBisnis as $bisnis): ?>
                                    <option value="<?= $bisnis['id_bisnis']; ?>" <?= old('id_bisnis', $selectedBisnis) == $bisnis['id_bisnis'] ? 'selected' : '' ?>>
                                        <?= $bisnis['nama_bisnis']; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control tiny" id="caption" name="caption" rows="4" placeholder="Tulis caption konten di sini..."><?= old('caption', $konten['caption']) ?></textarea>
                        <div class="invalid-feedback">
                            Caption harus diisi
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="date" class="form-control" id="tgl_upload" name="tgl_upload" value="<?= old('tgl_upload', $konten['tgl_upload']) ?>" required>
                    ...
                    <div class="col-md-6">
                        <div class="border p-3 rounded h-100">
                            ...
                            <div id="platform-container" class="d-flex flex-column gap-2">
                                <small class="text-muted">Memuat platform...</small>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="border p-3 rounded">
                            ...
                            <?php if (!empty($konten['cover'])): ?>
                                <div class="mb-3">
                                    ...
                                    <img src="<?= base_url('assets/sosmed/cover/' . $konten['cover']) ?>" alt="Cover Lama" 
                            ...
                            <small class="text-muted d-block mt-2">
                                ...
                                Ukuran maks. 2MB, format JPG/PNG. Kosongkan jika tidak ingin mengganti.
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="border p-3 rounded">
                            ...
                            <?php if (!empty($kontenFiles)): ?>
                                <div class="mb-3">
                                    <small class="text-muted d-block mb-2">Konten saat ini:</small>
                                    <div class="row g-2">
                                        <?php foreach ($kontenFiles as $file): ?>
                                            <div class="col-6 col-md-4">
                                                <div class="card position-relative">
                                                    <a href="<?= route_to('konten.deleteMedia', $file['id_detail_konten']) ?>" 
                                                       ...
                                                       style="width: 25px; height: 25px; z-index: 10;">
                                                    ...
                                                    <?php else: ?>
                                                        <img src="<?= base_url('assets/sosmed/konten/' . $file['media']) ?>" 
                            ...
                            <small class="text-muted d-block mt-2">
                                <i class="bi bi-info-circle me-2"></i>
                                Bisa pilih multiple file, format gambar/video. Kosongkan jika tidak ingin menambah file baru.
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a href="<?= route_to('konten') ?>" class="btn btn-secondary btn-lg d-flex align-items-center">
                            <span>Kembali</span>
                        </a>
    ...
    <script>
        ...
        // Load otomatis jika ada old('id_bisnis') atau selectedBisnis
