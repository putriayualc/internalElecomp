...
<title>Edit Artikel Internal</title>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="judul_artikel" name="judul_artikel" placeholder="Judul Artikel" value="<?= old('judul_artikel', $artikel['judul_artikel']) ?>" required>
                    ...
                    <div class="col-12">
                        <div class="form-floating">
                            <input type="url" class="form-control" id="link" name="link" placeholder="Link Artikel" value="<?= old('link', $artikel['link']) ?>" required>
                            <label for="link">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="keyword" name="keyword" placeholder="Keyword" value="<?= old('keyword', $artikel['keyword']) ?>">
                            <label for="keyword">
