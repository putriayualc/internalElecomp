...
<!-- Pop Up Telat / Bolos -->
<center>
<div id="TelatBolos" class="custom-modal">
  <div class="custom-modal-content" >
    <div class="custom-modal-header" style="background-color: grey; color: black;">
      <span id="customModalLabel" >Telat / Bolos</span>
      <button id="closeTB" class="close-btn">&times;</button>
    </div>
    <div class="custom-modal-body" style="overflow-y: scroll;">
      <table class="table table-striped">
        <thead>
        ...
        <tbody>
            ...
            <?php foreach ($absen as $item):?>
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($item['status'] == 'Sakit'): ?>
                      <button type="button" class="btnSakit" style="border: none;"
                        data-keterangan="<?= $item['keterangan']?>"
                        data-bukti="<?= $item['foto_suratDokter'] ?>"
...
<style>
  .modal {
    ...
    overflow-y: auto;
    background-color: rgba(0,0,0,0.6);
    padding: 40px 10px; /* Jarak dari atas dan bawah */
