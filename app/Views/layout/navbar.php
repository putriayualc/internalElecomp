<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
            ...
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <?php if ($role === 'user') : ?>
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link <?= service('uri')->getSegment(1) == 'penilaian' ? 'active' : '' ?>" href="<?= route_to('penilaian'); ?>" href="<?= route_to('penilaian') ?>">
                            <span class="nav-icon">
        ...
        3.522-3.356c.329-.32.158-.888-.283-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 
        5.119l-4.898.696c-.441.062-.612.63-.283.95l3.522 
        3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 
        0 0 0-.163-.505L1.71 6.905l4.052-.576a.525.525 0 
        0 0 .393-.288L8 2.223l1.847 3.818a.525.525 0 0 0 
        .393.288l4.052.575-2.905 2.78a.565.565 0 0 0-.163.506l.694 
                            ...
                            <ul class="submenu list-unstyled ps-4">
                                ...
                                <li>
                                    <a href="<?= route_to('na') ?>" class="nav-link d-flex align-items-center <?= $segment == 'nilai_akhir' ? 'active' : '' ?>">
                                        <i class="bi bi-award me-2"></i> Nilai Akhir
                                    </a>
                                </li>
                            </ul>
                        </div>
